...
var attNames = ['1999', '2000', '2001', '2002',
...
function setMap(){
  ...
  var map = new L.map('map').setView([39, -105], 3)
...
d3.json("../data/OO_state.json", function(error, jsonData) {
  ...
  function createDropdown(jsonData){
    ...
    .append("div")
    .html("<h4> Select Year to Explore </h4>")
    .append("select")
