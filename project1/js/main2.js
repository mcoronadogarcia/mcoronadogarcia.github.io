...
"LHS_1980", "HS_1980", "SC_1980", "C_1980",
"LHS_1990", "HS_1990", "SC_1990", "C_1990",
"LHS_2000", "HS_2000", "SC_2000", "C_2000",
"LHS_1216", "HS_1216", "SC_1216", "C_1216"];
...
function setMap(){
  ...
  var map = new L.map('map').setView([39, -105], 6)
...
d3.json("HWdata/colorado_ed.json", function(error, jsonData) {
  ...
  function createDropdown(jsonData){
    ...
    .append("div")
    .html("<h4> Select Variable to Examine </h4>")
    .append("select")
    ...
    .text(function(d) {
      ...
      //   if(attNames[i] = "colorado_3"){
      //     d = "Less than a High School Diploma: 1970";
      //   } else {
          // d = d.replace("_", "")
          // d = d.replace("colorado", "");
        // }
        return d;
      // }
    });
